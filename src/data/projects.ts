...
export const projects: Project[] = [
    {
        ...
        company: "Freelance",
        description:
            "Site vitrine pour une sophrologue basée en région parisienne.",
    ...
    },
    {
        ...
        company: "Freelance",
        description:
            "Site vitrine et éditorial pour un studio de développement de sites web. Le projet est en cours de finitions.",
        tasks: ["Maquettage", "Développement", "Mise en production"],
    ...
    },
    {
        ...
        description:
            "Portails en intranet pour réaliser des opérations sur le réseau interne.",
    ...
    },
    {
        ...
        duration: "6 mois",
        description:
            "Site Web éditorial d’un fonds de dotation territorial du Crédit Agricole.",
        tasks: [
            "Agile SCRUM",
    ...
    },
    {
        ...
        duration: "6 mois",
        description:
            "Application de gestion d’un foyer d’hébergement de victimes de traite humaine.",
        tasks: [
            "Agile SCRUM",
